...
class Product < ApplicationRecord
  ...
  has_many :lead_phase_products, dependent: :destroy
  has_many :lead_phases, through: :lead_phase_products

  def using_lead_phase?(lead_phase)
    lead_phases.include?(lead_phase)
  end
end
