...
class CompanyPage::CompanyController < ApplicationController
  ...
  private
    def company_params
      params.require(:company).permit(:address, :address2, :contract_type, :coprate_number, :email, :fax, :image, :name, :name_kana, :phone, :postcode,
:settlement_month, :prefecture_id)
    end
end
