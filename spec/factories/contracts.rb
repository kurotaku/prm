...
#  index_contracts_on_select_item_10_id  (select_item_10_id)
#  index_contracts_on_select_item_1_id   (select_item_1_id)
#  index_contracts_on_select_item_2_id   (select_item_2_id)
#  index_contracts_on_select_item_3_id   (select_item_3_id)
#  index_contracts_on_select_item_4_id   (select_item_4_id)
#  index_contracts_on_select_item_5_id   (select_item_5_id)
#  index_contracts_on_select_item_6_id   (select_item_6_id)
#  index_contracts_on_select_item_7_id   (select_item_7_id)
#  index_contracts_on_select_item_8_id   (select_item_8_id)
#  index_contracts_on_select_item_9_id   (select_item_9_id)
#  index_contracts_on_staff_id           (staff_id)
#  index_contracts_on_vendor_group_id    (vendor_group_id)
#
# Foreign Keys
#
...
FactoryBot.define do
  factory :contract do
    ...
    contract_type { 1 }
    name { "MyString" }
    contracted_at { "2021-06-08 22:38:07" }
    contract_end_at { "2021-06-08 22:38:07" }
  end
end
